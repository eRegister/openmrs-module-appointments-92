...
public class AppointmentsMissedScheduler extends AbstractTask {
    ...
    public void execute() {
        ...
        AppointmentStatusMarkerService appointmentStatusMarkerService = Context.getService(AppointmentStatusMarkerService.class);
         appointmentStatusMarkerService.markAllMissedAppointments(appointmentStatusMarkerService.schedulertStartDateTime(0), appointmentStatusMarkerService.schedulerEndDateTime());
